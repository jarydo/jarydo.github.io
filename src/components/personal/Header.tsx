  ...
  const socraticaWebRingItems: MenuItem[] = [
    {
      name: "Socratica",
      onClick: () => {
        window.open("https://socrati.ca/webring/");
      },
    },
    {
      name: "←",
      onClick: () => {
        window.open("https://socrati.ca/webring/jaryddiamond.com/prev");
      },
    },
    {
      name: "→",
      onClick: () => {
        window.open("https://socrati.ca/webring/jaryddiamond.com/next");
      },
    },
  ];
