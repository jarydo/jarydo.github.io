...
const Home = forwardRef<HTMLElement, { title: string }>((props, ref) => {
    ...
    return (
        <section id="home" ref={ref} className="min-h-screen flex flex-col items-center justify-around">
            ...
            <div className="max-w-4xl mx-auto mb-6 text-center">
                ...
                <div className="flex justify-center space-x-10 relative z-40">
                    {[
                        { href: "https://arcticwolf.com/", src: "/arctic_wolf.png", alt: "Arctic Wolf" },
                        { href: "https://99ravens.ai/", src: "/99_ravens.png", alt: "99 Ravens" },
                        { href: "https://horizn.com/", src: "/horizn.png", alt: "Horizn" },
                        { href: "https://www.arcticai.co/", src: "/arctic_ai.png", alt: "Arctic AI" },
                        { href: "https://www.mikobyte.com/", src: "/mikobyte.webp", alt: "Mikobyte Solutions" },
                    ].map((company, index) => (
                        <a 
                            key={index}
                            href={company.href} 
                        ...
                        >
                            <img src={company.src} alt={company.alt} className="h-10 relative z-10" />
                        </a>
                    ))}
                </div>
            </div>
